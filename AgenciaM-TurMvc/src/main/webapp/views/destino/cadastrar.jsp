		...
		<section class="container-fluid conteiner-segundario">
			<main>
				<section class="section container">
					<form action="../../destino-cadastrar" method="post"
						class="form-control" enctype="multipart/form-data">
						<fieldset>
							<legend class="text-center h3">Cadastrar Destino</legend>
							<div>
							...
							<div>
								<label for="preco">Preço</label> <input type="number"
									class="form-control" step=".01" id="preco" name="preco">
							</div>
							<div>
								<label for="imagem">Imagem</label> <input type="file"
									class="form-control" id="imagem" name="imagem">
							</div>
							<div>
								<button type="submit" class="btn btn-dark mt-2 botao">Cadastrar</button>

								<a href="../../destino" class="btn btn-dark mt-2 botao">Cancelar</a>
							</div>
						</fieldset>
					</form>
				</section>
