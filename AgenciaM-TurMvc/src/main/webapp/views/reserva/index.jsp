		...
		<section class="container-fluid conteiner-segundario">
			<main>
				<section class="container">
					...
					<div class="p-4">
						<a href="./views/reserva/cadastrar.jsp"
						...
						<table class="table table-responsive table-hover text-center">
							...
							<tbody>
								<jstl:forEach items="${listaReserva}" var="r">
									<tr>
										<td>${r.numeroReserva}</td>
										<td>${r.dataReserva}</td>
										<td>${r.valorReserva}</td>
										<td>${r.formaPagamento}</td>
										<td>${r.cliente.cpf}</td>
										<td>${r.destino.id}</td>
										<td>
											<div class="d-flex">
												<a href="reserva-editar?numeroReserva=${r.numeroReserva}"
													class="mx-1" title="Editar"> <i
													class="bi bi-pencil-square"></i>
												</a> <a href="reserva-deletar?numeroReserva=${r.numeroReserva}"
													class="mx-1" title="Remover"
													onclick="return confirm('Deseja excluir a reserva do número ${r.numeroReserva}.')">
