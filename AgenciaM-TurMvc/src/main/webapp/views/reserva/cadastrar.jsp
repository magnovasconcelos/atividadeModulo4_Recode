...
<link rel="stylesheet" type="text/css"
	href="/AgenciaM-TurMvc/assets/css/style.css" />
</head>
		...
		<nav
			...
			<section class="section container-fluid">
				<a class="navbar-brand" href="#"><img
					src="/AgenciaM-TurMvc/assets/img/imgLogo/mTur.jpg"
		...
		<section class="container-fluid conteiner-segundario">
			<main>
				<section class="section container">
					<form action="/AgenciaM-TurMvc/reserva-cadastrar"
						class="form-control">
						<fieldset>
							<legend class="text-center h3">Cadastro Reserva</legend>
							<div>
							...
							<div>
								<label for="valor">Valor</label> <input type="number"
									class="form-control" step=".01" id="valor" name="valor"
									value="${destino.precoDestino}">
							</div>
							<div>
								<label for="formaPagamento">Forma de Pagamento</label> <select
									class="form-control" name="formaPagamento">
									<option id="formaPagamento">Pix</option>
									<option id="formaPagamento">Cartão de Crédito</option>
									<option id="formaPagamento">Boleto</option>
								</select>
							</div>
							<div>
							...
							<div>
								<label for="id">Id Destino</label> <input type="text"
									class="form-control" id="id" name="id" value="${destino.id}">
							</div>
							<div>
								<button type="submit" class="btn btn-dark mt-2 botao">Cadastrar</button>

								<a href="/AgenciaM-TurMvc/reserva"
									class="btn btn-dark mt-2 botao">Cancelar</a>
							</div>
						</fieldset>
					</form>
				</section>
