		...
		<section class="container-fluid conteiner-segundario">
			<main>
				<section class="container">
					<div class="p-4">
						<a href="./views/cliente/cadastrar.jsp"
							class="btn btn-dark mb-2 botao">Novo</a> <a href="/AgenciaM-TurMvc/index.jsp"
							...
							<tbody>
								...
								<jstl:forEach items="${listaCliente}" var="c">
									<tr>
										...
										<td>
											<div class="d-flex">
												<a href="cliente-editar?cpf=${c.cpf}" class="mx-1"
													title="Editar"> <i class="bi bi-pencil-square"></i>
												</a> <a href="cliente-deletar?cpf=${c.cpf}" class="mx-1"
													title="Cancelar"
